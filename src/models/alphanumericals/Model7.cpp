 ...
 **/
class Model7 : public Project::Model {
public:
    Model7(glm::mat4 parentMatrix, glm::vec3 position, float rotation, glm::vec3 scale) : Project::Model::Model(parentMatrix, position, rotation, scale) {
...
protected:
    ...
    void DrawModel(Project::DrawContext context) {
        ...
        // Bottom
        worldMatrix = groupMatrix * partTranslationMatrix(0.375f, -0.125f, 0.0f)  * partScalingMatrix(0.125f, 0.75f, 0.125f);
        glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &worldMatrix[0][0]);
        glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
    }
