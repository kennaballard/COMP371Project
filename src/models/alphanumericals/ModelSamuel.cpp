 ...
 **/
class ModelSamuel : public Project::Model {
public:
    ModelSamuel(glm::vec3 position, glm::vec3 rotation, glm::vec3 scale) : Project::Model::Model(position, rotation, scale) {
        ...
        addChild(new Model0(position + posK, rotation, scale));
        addChild(new Model4(position + posY, rotation, scale));
        addChild(new ModelY(position + pos4, rotation, scale));
        addChild(new ModelK(position + pos0, rotation, scale));
    }
protected:
    /**
